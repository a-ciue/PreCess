...
public:
    ...
    struct Data {
        ...
        const std::unordered_map<int, std::unique_ptr<Group>>* group;
    };
    virtual Data getMeshData(const QString& model_name) = 0;
};
...
public:
    ...
    Data getMeshData(const QString& model_name) override;
...
private:
    ModelData* getModelData(const QString& model_name) const;
