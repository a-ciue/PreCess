...
TEST_CASE("TetGenLibHandler::args_type() returns correct parameter count and types")
{
    ...
    SECTION("Parameter 0 (Combo): keep only largest surface shell")
    {
    ...
    SECTION("Parameter 1 (Float): quality bound q")
    {
    ...
    SECTION("Parameter 2 (Float): max element volume a")
    {
    ...
    SECTION("Parameter 3 (Combo): preserve original surface")
    {
    ...
    SECTION("Parameter 4 (Combo): detect self-intersection only")
    {
    ...
    SECTION("Parameter 5 (Combo): output mode")
    {
    ...
    SECTION("Parameter 6 (Text): advanced TetGen switches")
    {
