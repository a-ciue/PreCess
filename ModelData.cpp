...
bool ModelData::isMesh()   const { return type_ == Type::Mesh; }
bool ModelData::isSpline() const { return type_ == Type::Spline; }

MeshData& ModelData::mesh() { return std::get<MeshData>(data_); }
const MeshData& ModelData::mesh() const { return std::get<MeshData>(data_); }

SplineData& ModelData::spline() { return std::get<SplineData>(data_); }
const SplineData& ModelData::spline() const { return std::get<SplineData>(data_); }
